...
World::World()
{
	...
	Npc* hinter2 = new Npc("Fellow Knight", "A knight who can provide you with useful information.", 70, 40, 60, 20, room3, "The thief king's knights are powerful and dangerous. They hone their skills in the training ground. One of them holds the key to the king's throne.", HINTER);
	...
	Npc* merchant = new Npc("Merchant", "A merchant who can sell you useful items.", 50, 30, 40, 150, room3, "Have a look at my wares.", MERCHANT);
	...
	Creature* knightsChest = new Creature("Chest", "A chest that contains useful items.", 1000, 0, 0, 15, room5, CHEST);
	knightsChest->addItem(kingSword);
	knightsChest->addItem(gem);
	Creature* magesChest = new Creature("Chest", "A chest that contains useful items.", 1000, 0, 0, 15, room7, CHEST);
